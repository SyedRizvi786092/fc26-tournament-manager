  ...
  return (
    <div className="profiles-page">
      ...
      <div className="profiles-body" style={{ maxWidth: 840, paddingTop: 20 }}>
        ...
        {/* ── DEFAULT VIEW: LIFETIME MANAGER STANDINGS (NO WIN RATE) ────── */}
        ...
        {activeTab === 'performance' && (
          <div>
            {/* Match Record Standings */}
            <div className="setup-card" style={{ marginBottom: 20 }}>
              <div className="setup-card-title">📈 Detailed Match Record (Sorted by Win %)</div>
              <div className="standings-wrap">
                <table className="standings-table">
                  <thead>
                    <tr>
            ...
            {/* Form & Longest Winning Streak */}
            <div className="setup-card">
              <div className="setup-card-title">🔥 Current Form (Last 5) &amp; Longest Win Streak</div>
          ...
          <div>
            ...
            <div className="setup-card" style={{ marginBottom: 20 }}>
              <div className="setup-card-title" style={{ justifyContent: 'space-between', flexWrap: 'wrap', gap: 8 }}>
                <span>⚽ Goal Machine Standings</span>
            ...
            {/* Record High-Scoring Matches & Blowouts */}
              ...
              <div className="setup-card">
                ...
                {goalData.largestMargin.length ? goalData.largestMargin.map(m => (
                  <div key={m.id} className="record-card" style={{ marginBottom: 8 }}>
                    <div className="record-title">{m.tournamentName}</div>
              ...
              {h2hData ? (
                <div>
                  <div className="h2h-stat-row">
                    ...
                    <span style={{ fontWeight: 600, color: 'var(--t2)' }}>Direct Match Wins (Total: {h2hData.totalPlayed})</span>
                  ...
                  <div className="h2h-stat-row">
                    <span style={{ fontWeight: 700, color: 'var(--gold)' }}>{h2hData.aPlayoffWins} W</span>
                    <span style={{ fontWeight: 600, color: 'var(--t2)' }}>Playoff &amp; Final Wins (Total: {h2hData.playoffPlayed})</span>
                    <span style={{ fontWeight: 700, color: 'var(--gold)' }}>{h2hData.bPlayoffWins} W</span>
                  </div>
                </div>
              ) : (
        ...
        {activeTab === 'clutch' && (
          <div>
            {/* Trophy Cabinet & Finals Win Rate */}
            <div className="setup-card" style={{ marginBottom: 20 }}>
                ...
                <table className="standings-table">
                  <thead>
                    <tr>
                      <th>Rank</th>
                      <th style={{ textAlign: 'left', paddingLeft: 10 }}>Manager</th>
                      <th>Gold 🥇</th><th>Silver 🥈</th><th>Finals</th>
              ...
              <div className="standings-wrap">
                <table className="standings-table">
                  <thead>
                    <tr>
                      <th style={{ textAlign: 'left', paddingLeft: 10 }}>Manager</th>
                      <th>Shootouts Played</th><th>Won (W)</th><th>Lost (L)</th>
        ...
        {activeTab === 'discipline' && (
          <div>
            ...
            {/* Squad Player Red Cards Leaderboard */}
            <div className="setup-card">
                  ...
                  <table className="standings-table">
                    <thead>
                      <tr>
                        ...
                        <th style={{ textAlign: 'left' }}>Manager / Team</th>
